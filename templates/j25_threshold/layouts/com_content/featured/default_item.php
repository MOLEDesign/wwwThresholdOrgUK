...
<article class="item" data-permalink="<?php echo JRoute::_(ContentHelperRoute::getArticleRoute($this->item->slug, $this->item->catid), true, -1); ?>">
	...
	<?php if(isset($image)): ?>
		<?php if (isset($imgfloat) && htmlspecialchars($imgfloat) == 'none' && $warp["config"]->get("featured_spotlight", 1)) : ?>
			<a class="featured-image featured-spotlight" href="<?php echo JRoute::_(ContentHelperRoute::getArticleRoute($this->item->slug, $this->item->catid)); ?>" title="<?php echo $this->escape($this->item->title); ?>">
					<?php echo $image; ?>
				<div class="overlay"></div>
			</a>
		<?php else: ?>
			<a class="featured-image" href="<?php echo JRoute::_(ContentHelperRoute::getArticleRoute($this->item->slug, $this->item->catid)); ?>" title="<?php echo $this->escape($this->item->title); ?>">
				<?php echo $image; ?>
			</a>
		<?php endif; ?>
	<?php endif; ?>
